...
- [ ] **Task 1.4 — Cookie Encryption Utility**
  - Layer: Backend
...
- [ ] **Task 1.5 — Redis Client + Audit Log Middleware**
  - Layer: Backend
...
- [ ] **Task 2.1 — Auth Service + User Seed**
  - Layer: Backend
...
- [ ] **Task 3.2 — Cookie Import + Health Check**
  - Layer: Backend
...
- [ ] **Task 4.1 — Playwright Session Pool**
...
- [ ] **Task 4.2 — Session Service + DB Tracking**
  - Layer: Backend
...
- [ ] **Task 5.2 — Celery Infrastructure**
  - Layer: Backend
...
- [ ] **Task 5.3 — Facebook Playwright Automation**
  - Layer: Backend (Infrastructure)
...
- [ ] **Task 5.4 — Facebook Publish Task + Status Tracking**
  - Layer: Backend
...
- [ ] **Task 6.1 — TikTok Playwright Automation**
  - Layer: Backend (Infrastructure)
...
- [ ] **Task 7.1 — Celery Beat Scheduler**
  - Layer: Backend
...
- [ ] **Task 7.2 — Cookie Health Check Task**
  - Layer: Backend
...
- [ ] **Task 8.1 — Frontend Shell: Router + Auth Store + API Client**
  - Layer: Frontend
  - Files:
...
- [ ] **Task 8.2 — Account Management UI**
  - Layer: Frontend
  - Files:
...
- [ ] **Task 8.4 — Browser Sessions Live View**
  - Layer: Frontend
  - Files:
...
- [ ] **Task 8.6 — Monitoring + Audit Log UI**
  - Layer: Frontend
  - Files:
...
- [ ] **Task 9.1 — Grafana + Prometheus + Loki Setup**
  - Layer: Infrastructure
  - Files:
...
- [ ] **Task 10.4 — Load Test: Browser Farm**
...
- [ ] **Task 10.5 — README + Docker Compose Docs**
